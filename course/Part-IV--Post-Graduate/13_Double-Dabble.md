...
<div align="center"><img src="./images/binary-to-bcd-rom.png" alt="Binary to BCD ROM Diagram" width="512px"/><br/><em>Figure: A binary-to-BCD converter built from a decoder and an 8-bit-wide ROM matrix. One active input line drives the correct tens and ones outputs.</em></div><br/>
...
<div align="center"><img src="./images/double-dabble-final-minecraft.png" alt="Double Dabble Final Build" width="512px"/><br/><em>Figure: The completed decimal-output system. A single 4-bit binary result is converted into separate tens and ones digits and displayed as an ordinary decimal number.</em></div><br/>
